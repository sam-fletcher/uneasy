...
func TestEligibleSelfFlawResourceIDs(t *testing.T) {
	views := []ResourceFlawView{
		{AssetID: 1, AssetType: model.AssetResource, IntactMarginaliaCount: 2}, // eligible
		{AssetID: 2, AssetType: model.AssetResource, IsDestroyed: true, IntactMarginaliaCount: 1},
		{AssetID: 3, AssetType: model.AssetPeer, IntactMarginaliaCount: 3},     // not a resource
		{AssetID: 4, AssetType: model.AssetResource, IntactMarginaliaCount: 0}, // no intact marginalia
		{AssetID: 5, AssetType: model.AssetResource, IntactMarginaliaCount: 1}, // already flawed
	}
